            ...
            : coins.map((coin) => {
                ...
                return (
                  <tr key={coin.id}>
                    ...
                    <td
                      className={`pr-20 py-3 text-right font-semibold border-b border-gray-800 text-sm ${priceChangeClass}`}
                    >
                      $
                      {livePrice !== undefined
                    ...
                    <td className="px-6 py-3 text-right font-semibold border-b border-gray-800 text-sm">
                      $
                      {livemc !== undefined
                        ? Math.round(livemc).toLocaleString()
